...
<head>
    ...
    <title> @yield('page_title', config('app.store_name') )</title>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/branding/logo.png') }}" type="image/png">
    <link rel="icon" href="{{ asset('assets/img/branding/logo.png') }}" type="image/png">
