    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <div class="mb-1">
                    <span class="h5" id="order-number"></span><span class="badge bg-label-success me-1 ms-2" id="order-payment-status"></span>
                    <span class="badge bg-label-info" id="order-status"></span>
                </div>
                <p class="mb-0" id="order-date-text"> <span id="orderYear"></span></p>
                        ...
                        <div class="d-flex justify-content-end align-items-center m-6 mb-2">
                            <div class="order-calculations">
                                <div class="d-flex justify-content-start mb-2">
                                    ...
                                    <h6 id="order-subtotal" class="mb-0">$0</h6>
                                </div>
                                <div class="d-flex justify-content-start mb-2">
                                    <span class="w-px-100 text-heading">Discount:</span>
                                    <h6 id="order-discount" class="mb-0">$0</h6>
                                </div>
                                <div class="d-flex justify-content-start mb-2">
                                    <span class="w-px-100 text-heading">Tax:</span>
                                    <h6 id="order-tax" class="mb-0">$0</h6>
                                </div>
                                <div class="d-flex justify-content-start">
                                    <h6 class="w-px-100 mb-0">Total:</h6>
                                    <h6 id="order-total" class="mb-0">$0</h6>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-1" id="customer-email"></p>
                        <p class="mb-0" id="customer-number"></p>
                    </div>
                </div>
                ...
                <div class="mb-6 col ecommerce-select2-dropdown">
                    ...
                    <select id="status-org" class="select2 form-select" data-placeholder="Pending">
